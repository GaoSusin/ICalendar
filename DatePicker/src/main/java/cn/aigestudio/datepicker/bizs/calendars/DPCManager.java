...
public final class DPCManager {
    ...
    public static HashMap<Integer, HashMap<Integer, DPInfo[][]>> getDateCache() {
        return DATE_CACHE;
    }

    public static HashMap<String, Set<String>> getDecorCacheBg() {
        return DECOR_CACHE_BG;
    }

    public static HashMap<String, Set<String>> getDecorCacheTl() {
        return DECOR_CACHE_TL;
    }

    public static HashMap<String, Set<String>> getDecorCacheT() {
        return DECOR_CACHE_T;
    }

    public static HashMap<String, Set<String>> getDecorCacheTr() {
        return DECOR_CACHE_TR;
    }

    public static HashMap<String, Set<String>> getDecorCacheL() {
        return DECOR_CACHE_L;
    }

    public static HashMap<String, Set<String>> getDecorCacheR() {
        return DECOR_CACHE_R;
    }
